...
class CategoriesController extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.products.categoryUpdate', [
            'category'=>$category,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('image')) {
            if ($category->image) {
                Storage::delete('public/images/products/' . $category->image);
            }
    ...
    public function destroy($id)
    {
        ...
        if ($post->image) {
            $imagePath = public_path('storage/images/products/' . $post->image);
        ...
        return redirect('getCategories')->with('success', 'Data has been deleted');
    }
