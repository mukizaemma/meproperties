...
class AdminController extends Controller
{
    public function index()
    {
        ...
        $totalPropertyPrice = Property::sum('price');
        $totalCarPrice = Car::sum('price');
        $totalDealPrice = Deal::sum('price');
        $totalSubscriptionPrice = Subscription::sum('amount_paid');

        $totalSum = $totalPropertyPrice + $totalCarPrice + $totalDealPrice + $totalSubscriptionPrice;
