(function ($) {
  ...
  document.addEventListener('livewire:load', function () {
    // Optional: Handle smooth transitions between page content
    Livewire.hook('message.processed', (message, component) => {
        // This can be used to add custom animation or transitions
        // For example, using a page fade effect or similar
        window.scrollTo(0, 0); // To make sure the page scrolls to the top
    });
});
