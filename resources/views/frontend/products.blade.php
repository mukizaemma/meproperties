                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="property-box2 wow animated fadeInUp" data-wow-delay=".3s">
                                <div class="item-img">
                                    <a href="{{ route('product',['slug'=>$product->slug]) }}"><img src="{{ asset('storage/images/products/' .$product->image) }}" alt="property" style="height: 340px; object-fit: contain;"></a>
                                ...
                                <div class="item-category10"><a href="{{ route('product',['slug'=>$product->slug]) }}">{{ $product->advertType ?? 'For Rent' }}</a></div>
                                <div class="item-content">
                                    ...
                                    <div class="item-categoery3">
                                        <ul>
                                            <li><a href="{{ route('product',['slug'=>$product->slug]) }}" class="btn btn-dark"> View Details</a> </li>
                                            <li><a href="{{ route('product',['slug'=>$product->slug]) }}" class="btn btn-light"> Add to Cart</a> </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
