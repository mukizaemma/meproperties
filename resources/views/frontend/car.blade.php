                ...
                <div class="row">
                  <div class="col-lg-6 col-md-12">
                    <div class="single-list-cate">
                      <div class="item-categoery">{{ $car->advertType ?? 'For Rent' }}</div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-12">
                    <div class="single-list-price">{{ $car->currency }} {{ $car->price }}</div>
                  </div>
                </div>
                  ...
                  <div class="col-lg-8 col-md-12">
                    ...
                    <div class="single-item-address">
                      <ul>
                        ...
                        <li><i class="fas fa-clock"></i> {{ $car->created_at->diffForHumans() }} /</li>
                        <li><i class="fas fa-eye"></i>Views: {{ $car->views ?? '' }}</li>
                      </ul>
                    </div>
                  </div>
              ...
              <div class="row">
                          ...
                          <div class="swiper-wrapper">
                            <div class="swiper-slide">
                              <div class="feature-img1 zoom-image-hover">
                                <img
                                  src="{{ asset('storage/images/cars/' . $car->image) }}"
                                  alt="feature"
                                  width="798"
                                  height="420"
                                />
                            ...
                            @foreach($images as $image)
                              <div class="swiper-slide">
                                <div class="feature-img1 zoom-image-hover">
                                  <img
                                    src="{{ asset('storage/images/cars/' . $image->image) }}"
                                    alt="feature"
                                    width="798"
                                    height="420"
                                  />
                      ...
                      <div class="gallery-icon-box">
                        <div class="item-icon-box">
                          <ul class="item-number">
                            <li>Price :</li>
                            <li class="deep-clr">{{ $car->currency }} {{ $car->price }}</li>
                          </ul>
                        </div>
                        <div class="item-icon-box">
                          <ul class="item-number">
                            <li>Modal :</li>
                            <li class="deep-clr">{{ $car->model }}</li>
                          </ul>
                        </div>
                        <div class="item-icon-box">
                          <ul class="item-number">
                            <li>Doors :</li>
                            <li class="deep-clr">{{ $car->doors }}</</li>
                          </ul>
                        </div>
                        <div class="item-icon-box">
                          <ul class="item-number">
                            <li>Engine :</li>
                            <li class="deep-clr">{{ $car->engineType }}</</li>
                          </ul>
                        </div>
                      </div>
                      <div class="gallery-icon-box">
                        <div class="item-icon-box">
                          <ul class="item-number">
                            <li>Transmission :</li>
                            <li class="deep-clr">{{ $car->transmission }}</</li>
                          </ul>
                        </div>
                        <div class="item-icon-box">
                          <ul class="item-number">
                            <li>Made Year :</li>
                            <li class="deep-clr">{{ $car->year }}</</li>
                          </ul>
                        </div>
                        <div class="item-icon-box">
                          <ul class="item-number">
                            <li>Location :</li>
                            <li class="deep-clr">{{ $car->location }}</</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-lg-4 widget-break-lg sidebar-widget">
                  <div class="widget widget-contact-box">
                    ...
                    <div class="media d-flex">
                      ...
                      <div class="media-body flex-grow-1 ms-3">
                        <h4 class="item-title">{{ $car->subscription->names ?? '' }}</h4>
                        <div class="item-phn">
                          {{ $car->contact }} 
                        </div>
                        <div class="item-mail">{{ $car->email }}</div>
                    ...
                    <form class="contact-box rt-contact-form" action="{{ route('sendMessage') }}" method="POST">
                      @csrf
                      <input type="hidden" name="subject" value="Vehicle Inquiry">
                      <div class="row">
                  ...
                  <div class="widget widget-listing-box1">
                    ...
                    <div class="item-img">
                      <a href="{{ route('car',['slug'=>$carAdvert->slug]) }}"
                        ><img
                          src="{{ asset('storage/images/cars/' . $carAdvert->image) }}"
                          alt="widget"
                          width="540"
                          height="360"
                      /></a>
                      <div class="item-category-box1">
                        <div class="item-category">{{ $car->carAdvert ?? 'For Rent' }}</div>
                      </div>
                    </div>
                  ...
                  <div class="widget widget-post">
                    <div class="item-img">
                      <img src="{{ asset('storage/images/cars/' .$rs->image) }}" alt="widget" />
