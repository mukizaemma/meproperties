                ...
                <div class="row">
                  <div class="col-lg-6 col-md-12">
                    <div class="single-list-cate">
                      <div class="item-categoery">{{ $product->advertType ?? 'For Rent' }}</div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-12">
                    <div class="single-list-price">{{ $product->currency }} {{ $product->price }}</div>
                  </div>
                </div>
                  ...
                  <div class="col-lg-8 col-md-12">
                    ...
                    <div class="single-item-address">
                      <ul>
                        ...
                        <li><i class="fas fa-clock"></i> {{ $product->created_at->diffForHumans() }} /</li>
                        <li><i class="fas fa-eye"></i>Views: {{ $product->views }}</li>
                      </ul>
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-lg-8">
                  ...
                  <div class="single-listing-box1">
                      ...
                      <div class="gallery-icon-box">
                        <div class="item-icon-box">
                          <ul class="item-number">
                            <li>Price :</li>
                            <li class="deep-clr">{{ $product->currency }} {{ $product->price }}</li>
                          </ul>
                        </div>
                        <div class="item-icon-box">
                          <ul class="item-number">
                            <li>Advert Type :</li>
                            <li class="deep-clr">{{ $product->advertType }}</li>
                          </ul>
                        </div>
                        <div class="item-icon-box">
                          <ul class="item-number">
                            <li>Condition :</li>
                            <li class="deep-clr">{{ $product->condition }}</</li>
                          </ul>
                        </div>
                        <div class="item-icon-box">
                          <ul class="item-number">
                            <li>Location :</li>
                            <li class="deep-clr">{{ $product->location }}</</li>
                          </ul>
                        </div>
                      </div>
                    ...
                    {{-- <div class="overview-area video-box1">
                      <h3 class="item-title">Product Video</h3>
                      <div class="item-img">
                        <img
                ...
                <div class="col-lg-4 widget-break-lg sidebar-widget">
                  <div class="widget widget-contact-box">
                    ...
                    <div class="media d-flex">
                      ...
                      <div class="media-body flex-grow-1 ms-3">
                        <h4 class="item-title">{{ $product->subscription->names ?? '' }}</h4>
                        <div class="item-phn">
                          {{ $product->contact }}
                        </div>
                        <div class="item-mail">{{ $product->email }}</div>
                  ...
                  <div class="widget widget-listing-box1">
                    ...
                    <div class="item-img">
                      <a href="{{ route('product',['slug'=>$productAdvert->slug]) }}"
                        ><img
                          src="{{ asset('storage/images/products/' . $productAdvert->image) }}"
                          alt="widget"
                          width="540"
                          height="360"
                      /></a>
                      <div class="item-category-box1">
                        <div class="item-category">{{ $product->carAdvert ?? 'For Rent' }}</div>
                      </div>
                    </div>
                    @endif
                  ...
                  <div class="widget widget-post">
                    <div class="item-img">
                      <img src="{{ asset('storage/images/products/' .$rs->image) }}" alt="widget" />
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-5 col-sm-5">
              <div class="heading-button">
                <a href="{{ route('products') }}" class="heading-btn item-btn2"
                  >All Featured Products</a
                >
              </div>
            </div>
          </div>
