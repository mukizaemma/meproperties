                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('editService',['id'=>$rs->id]) }}">{{ $rs->name }}</a></td>
        ...
        <div class="modal fade" id="NewProduct">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" action="{{ route('postService') }}" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <label for="image" class="form-label">Cover Image<br> <span
                                    style="color: rgb(43, 40, 40)">(This Image should compressed to not greater than 1MB)</span></label>
