                                        ...
                                        <div class="form-body">
                                            ...
                                            {{-- <div class="row mb-4">
                                                <div class="col-lg-6 col-sm-12 mb-3">
                                                    <label style="font-weight: bold;">Value 1</label>
                                                    <textarea rows="4" class="form-control" name="mission" style="padding: 10px; border-radius: 8px;">{!! $data->mission !!}</textarea>
                                                </div>
                                                <div class="col-lg-6 col-sm-12 mb-3">
                                                    <label style="font-weight: bold;">Value 2</label>
                                                    <textarea rows="4" class="form-control" name="vision" style="padding: 10px; border-radius: 8px;">{!! $data->vision !!}</textarea>
                                                </div>
                                                <div class="col-lg-6 col-sm-12 mb-3">
                                                    <label style="font-weight: bold;">Value 3</label>
                                                    <textarea rows="4" class="form-control" name="storyDescription" style="padding: 10px; border-radius: 8px;">{!! $data->storyDescription !!}</textarea>
                                                </div>
                                            </div> --}}
